...
#define LOG_TAG "android.hardware.power-service.ginkgo"
...
int main() {
    LOG(INFO) << "Ginkgo Power HAL AIDL Service with Extension is starting.";
    ...
    LOG(INFO) << "Ginkgo Power HAL AIDL Service with Extension is started.";
    ...
    // should not reach
    LOG(ERROR) << "Ginkgo Power HAL AIDL Service with Extension just died.";
    return EXIT_FAILURE;
}
